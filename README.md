...
I’m a **Computer Science and Engineering student** with hands-on experience in **Full-Stack web development** and **applied AI/ML**.  
I focus on writing clean, maintainable code and building systems that solve real problems — from production-style web applications to AI-powered features. I value correctness, clarity, and continuous improvement as an engineer.
...
Currently focused on strengthening core engineering skills and building reliable, well-structured systems.

- **Deepening:** System design fundamentals and backend architecture  
- **Exploring:** Practical applications of machine learning and LLMs  
- **Improving:** Writing cleaner, test-driven, maintainable code  

---

### Let’s Connect

I’m always open to **collaboration, projects, and technical discussions**.  
If you’re working on something interesting or want to connect, feel free to reach out.
